            ...
            <div className={`container ${styles.content}`}>
                ...
                <div>
                    <Formik
                        ...
                        onSubmit={(values) => {
                            alert(
                                `Donation Successful: ${JSON.stringify(
                                    values,
                                    null,
                                    2
                                )}`
                            ...
                            <Form className={styles.donation_form}>
                                ...
                                <div className={styles.form_2}>
                                    ...
                                    <p>
                                        ...
                                        treated as confidential. These details
                                        shall not be divulged for any other
                                        purpose. By sharing your details, you
                                        agree to receive stories and updates
                                        from CRY via mobile, Whatsapp, landline,
                                        email and post. If you&apos;d like to
                                        change this, please send us an email on
                                        writetous@crymail.org
                                    </p>
                                    <p>
                                        I hereby declare that I am a citizen of
                                        India, making this donation out of my
                                        own funds. The information provided
                                        above is correct to the best of my
                                        knowledge. I know that all further
                                        communications will be done on contact
                                        details provided above
                                    </p>
                                    <p>
                                        Checkbox should be checked before
                                        continuing.
                                    </p>
                                    <button type="submit">
                                        Continue to Payment
